...
interface PlaneIconProps {
  sizeRem: number; // Use size in `rem`
}

export const PlaneIcon: React.FC<PlaneIconProps> = ({ sizeRem }) => (
  <svg
    className="plane-icon"
    width={`${sizeRem}rem`} // Convert size to `rem`
    height={`${sizeRem}rem`} // Convert size to `rem`
